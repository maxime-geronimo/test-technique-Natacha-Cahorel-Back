                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div>
                                        titre
                                        <br/>
                                        <input type="text" name="titre" class="form-control" placeholder="<?=($value["titre"]);?>">
                                    </div>

                                    <div>description
                                        <br/>
                                        <textarea name="description" id="" cols="30" rows="3" class="form-control" placeholder="<?=($value["description"]);?>"></textarea>
                                    </div>

                                    <div class="noDisplay">
                                        <select name="postModify" id="defPic" class="form-control">
                                            <optgroup>
                                                <option value="oui" name="postModify">oui</option>
                                            </optgroup>
                                        </select>
                                        <select name="id" id="idToModify" class="form-control">
                                            <optgroup>
                                                <option value="<?=($value["id"]);?>" name="id">oui</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        <button class="btn btn-primary" id="modifyPhotoBtn">Enregistrer</button>
                                    </div>

                                    <div>
                                        <a href="?deletePic=<?=($value["id"]);?>">
                                            Supprimer
                                        </a>
                                    </div>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="noDisplay">
                                    <select name="postAdd" id="defPic" class="form-control">
                                        <optgroup>
                                            <option value="oui" name="postAdd">oui</option>
                                        </optgroup>
                                    </select>
                                </div>
